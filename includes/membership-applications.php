...
<div class="wrap myjat-dashboard">
    ...
    <div class="myjat-dashboard-header">
        ...
        <div class="myjat-dashboard-actions">

            <a
                href="?page=myjat-membership-applications&export_csv=1"
                class="button button-primary myjat-export-btn">
...
<button class="button button-primary myjat-search-btn">
...
<div class="myjat-card myjat-filter-bar">
    ...
    <button class="button myjat-btn myjat-btn-light">
...
<div class="myjat-stats">
    ...
    <div class="myjat-stat-title">कुल आवेदन</div>
...
?>
            ...
            <td>
                ...
                <a
                    class="button button-small myjat-btn myjat-btn-light"
                ...
                <a
                    class="button button-small myjat-btn myjat-btn-primary"
            ...
            <td>
                ...
                if ( strtolower($row->status) === 'pending' ) {
                    ...
                    <a
                    class="button button-small myjat-btn myjat-btn-success"
                    ...
                    <a
                    class="button button-small myjat-btn myjat-btn-danger"
